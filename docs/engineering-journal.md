...
> 按时间线记录每个设计决策的背景、动机与依据。正序排列（最早在前），新日志追加到文末。
>
...
**依据**：
- [[2026-07-10-adventure-log-and-parser-architecture]]（完整利弊分析）
- `src/storyloom/parser/streaming_parser.py` 已不存在
