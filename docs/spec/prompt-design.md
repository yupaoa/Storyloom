...
3. 旅店老板从吧台后抬起头，手里的抹布停在半空："这么晚了还赶路？"
4. 角落里一个裹着斗篷的身影动了动——你看不清那人的脸，但注意到他手边的剑柄。
5. 老板给你倒了杯热麦酒，压低声音："那位客人等了你半个钟头。"
6. "他说有笔买卖——"老板瞥了眼角落，"但我劝你小心。最近这条路不太平。"
7. 你端起酒杯。斗篷人站了起来，身材比你预想的矮小，动作却异常轻盈。
8. 那人走到你桌前，摘下兜帽——一张布满疤痕的脸，但眼神出奇的平静。

--- options:main ---
choice: approach
A. 先开口："听说你手里有我要的情报。" -> take_lead
...
--- narrative:take_lead ---
9. "听说你手里有我要的情报。"你的声音不高，但在安静的旅店里每个字都很清晰。
10. 疤脸人微微一笑，从斗篷内袋掏出一个蜡封的羊皮纸卷。
11. "你要的东西在这里。"他把纸卷放在桌上，却没有松手。"但在打开之前——"
12. 他的目光越过你的肩膀，扫向旅店门口。"我们得先解决跟在后面的'尾巴'。"

--- narrative:wait ---
13. 你端起酒杯，不动声色地啜了一口。沉默是一种武器，你知道。
14. 疤脸人先沉不住气了。他从斗篷里掏出一个蜡封的羊皮纸卷，推到桌子中央。
15. "你比他们说的更沉得住气。"他咧开嘴，露出参差不齐的牙齿。"这很好。"
...
对话为主，旁白与对话交替，避免连续 3 段以上纯描写。选项后果在叙事中铺垫。bridge 之后制造悬念。
...
>
> 保证时限：`MIN × (1 − RATIO) × AUTO_ADVANCE_DELAY_MS / 1000` = 2.5s
当前时限：`PRE_BRIDGE_SEGMENTS × AUTO_ADVANCE_DELAY_MS / 1000` = 4.0s
